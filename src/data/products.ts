...
export const rubbers: Rubber[] = 
  ...
  },
  {
    ...
    "Blade_Level": "Beginner",
    "Blade_Affiliate_Link": "https://joola.com/products/joola-baseline-all-table-tennis-blade",
    "Reasoning": "5-ply all-wood (limba/top); soft outer veneers give high dwell and touch — good for slow, controlled blocks and for pairing with pips/anti where control is key."
  },
  {
    "Blade_Name": "ANDRO Timber 5 DEF",
    "Blade_Speed": 48,
    ...
    "Blade_Affiliate_Link": "https://www.tabletennis11.com/other_eng/andro-timber-5-def",
    "Reasoning": "TIMBER 5 DEF uses walnut/limba veneers and a thin construction optimized for maximum ball feeling and control — ideal for classic long-pips/anti defenders who need slow, predictable blade behavior. (source: Andro TIMBER 5 DEF product pages)."
  },
  {
    "Blade_Name": "JOOLA Chen Weixing (CWX) - Defender",
    "Blade_Speed": 58,
    "Blade_Control": 96,
    "Blade_Power": 52,
    "Blade_Grip": "Flared",
    "Blade_Price": 79.95,
    "Blade_Level": "Intermediate/Advanced",
    "Blade_Affiliate_Link": "https://joola.com/collections/precision-table-tennis-blades/products/chen-weixing-table-tennis-blade",
    "Reasoning": "5+2 ply (Limba / Koto / black-cloth / Kiri / black-cloth / Koto / Limba). The cloth layers and soft Limba outer veneers give exceptional control and damping — excellent for chopping/variation and pairing with long pips or anti-spin rubber. (source: JOOLA CWX pages)."
  },
  {
    "Blade_Name": "Butterfly Joo Sae Hyuk DEF",
    "Blade_Speed": 46,
    "Blade_Control": 95,
    "Blade_Power": 40,
    "Blade_Grip": "Flared",
    "Blade_Price": 129.99,
    "Blade_Level": "Advanced / Specialist",
    "Blade_Affiliate_Link": "https://www.teessport.com/blades-c5/butterfly-joo-sae-hyuk-def-table-tennis-blade-p1109",
    "Reasoning": "Designed with the world’s top defender Joo Sae Hyuk — 5-ply defensive blade with a slightly larger head and a construction tuned for long defence. Low speed, very high control; pairs extremely well with long pips or anti rubbers for disruption and chop. (source: Butterfly/Joo-Se-Hyuk product descriptions & reviews)."
  },
  {
    "Blade_Name": "Butterfly Defensive (premium defensive category)",
    "Blade_Speed": 54,
    "Blade_Control": 93,
    "Blade_Power": 48,
    "Blade_Grip": "Flared",
    "Blade_Price": 199.99,
    "Blade_Level": "Premium / Elite",
    "Blade_Affiliate_Link": "https://shop.butterflyonline.com/shop/table-tennis-blades",
    "Reasoning": "Butterfly's premium defensive line (R&D defensive blades) uses carefully selected veneers and damping tech to give exceptional control & touch at higher price points — perfect to pair with specialist long/short pips or anti rubbers when you want premium feel and build quality. (source: Butterfly blade catalog / defensive blade category)."
  }
];
...
export const preAssembledRackets: PreAssembledRacket[] = [

  {
    ...
    "Racket_Speed":  fifty_value,
    "Racket_Spin":  fifty_two_value,
    "Racket_Control":  eighty_value,
    "Racket_Power":  fifty_six_value,
    "Racket_Grip": "Flared",
    "Racket_Price": 19.99,
