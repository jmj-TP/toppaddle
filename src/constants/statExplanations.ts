...
export const statExplanations: Record<string, StatExplanation> = {
  ...
  Value: {
    ...
    detailed: "Value represents how much performance you get for each dollar spent. Calculated as: (Speed + Spin + Control + Power) ÷ Price × 100. A setup with 240 total stats at $180 scores 133 (capped at 100), meaning 1.33 stats per dollar - excellent value! A setup with 200 stats at $300 scores only 67 (0.67 stats per dollar). Higher value means better bang for your buck. Perfect ratio is 100 (1 stat per $1)."
  },
  Weight: {
