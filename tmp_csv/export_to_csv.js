...
function exportToCsv() {
    ...
    var formattedBlades = products_1.blades.map(function (b) { return ({
        Name: b.Blade_Name,
        Speed: b.Blade_Speed,
        Spin: b.Blade_Spin,
    ...
    var formattedRubbers = products_1.rubbers.map(function (r) { return ({
        Name: r.Rubber_Name,
    ...
    var formattedRackets = products_1.preAssembledRackets.map(function (r) { return ({
        Name: r.Racket_Name,
